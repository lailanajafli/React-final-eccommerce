      ...
      <div className="menu">
          ...
          <div>
            ...
            <div onClick={toggleSidebar} className="navbar-brand">
              <FontAwesomeIcon
                icon={faCartShopping}
                size="xl"
                style={{ color: "#ffffff", position: "relative", top: "11px" }}
              />{" "}
        ...
        <div>
          <div className="colorButton">
            ...
            <Link className="name" to="/women">
              Women
            </Link>
            <Link className="name" to="/men">
              Men
            </Link>
            <Link className="name" to="/accessories">
              Accessories
            </Link>
            <Link className="name" to="/electronics">
              Electronics
            </Link>
          </div>
